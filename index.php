...
<section class="slideshow-home" style="background-color:#8bc1e9;">
  <div class="w3-content w3-display-container" style="margin:0 auto;">
        <img class="mySlides" src="pics/slideshow/razerblade.png" style="width:700px; height: auto;">
        <img class="mySlides" src="pics/slideshow/dellxps.png" style="width:700px; height: auto;">
        <img class="mySlides" src="pics/slideshow/hp.png" style="width:700px; height: auto;">
