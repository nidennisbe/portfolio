...
<section>
		  <div name="title" style="background-color:#FF4823;height:100px;"><h1 style="color:white;padding:35px;font-size:1.5em;border-radius:4px;" ><strong>Career History</strong></h1></div>
      <br>
