...
<head>
    ...
    <link rel="stylesheet" href="style/mobile_version.css">
  ...
  <div class="form">
    <div class="container">
      ...
      <form class="login-form" action="login_process.php" method="get">
          <input type="text" placeholder="Username" name="username" name="username"/>
          ...
          <a href="sign_in.php">I already have account </a>
      </form>
    </div>
