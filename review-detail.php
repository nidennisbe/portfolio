...
?>
<div name="title" style="border-bottom: solid 1px #6998ba;height:100px;"><h1 style="color:#6998ba;padding:35px" ><strong>  <h3 id="h3-title-item"><?php echo $row['title'];?></h3></strong></h1></div>
<section
<div id="content">
  <?php do { ?>
